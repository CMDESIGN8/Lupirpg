...
import CommonRoom from '../game/CommonRoom.jsx'; // ✅ Cambiar esta importación
    ...
    <div className="game-dashboard">
      ...
      <div className="dashboard-content">
        ...
        <div className="player-card">
          {/* ... (todo el contenido de la ficha del jugador igual) ... */}
        ...
        <div className="skills-card">
          {/* ... (contenido de habilidades igual) ... */}
          <div className="card-header">
            <h2>ESTADÍSTICAS</h2>
            <div className="header-line"></div>
        ...
        <div className="actions-card">
          ...
          <div className="action-buttons">
            ...
            {/* BOTÓN MODIFICADO - Ahora cambia la vista */}
            <button 
              className="action-btn secondary" 
              onClick={() => setView('common-room')}
            >
              <span className="nav-icon">🏠</span>
...
// Componente principal que maneja las vistas
